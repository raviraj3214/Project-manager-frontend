...
export default function Board() {
  ...
  const { isOpen: isAddMemberOpen, toggleModal: toggleAddMemberModal } = useModal(); // Modal control
  ...
  return (
    <div className={styles.container}>
      ...
      <div className={styles.board}>
        ...
        <button onClick={toggleAddMemberModal} className={styles.btn}>
            <User size={16} className={styles.userIcon} /> {/* User icon added */}
            Add People
          </button> 
        </div>
